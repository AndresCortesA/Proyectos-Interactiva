...
//	 Desarrolle una aplicación en Java que permita convertir entre kilos, libras y gramos.
//	 También de centímetros a metros y de metros a centímetros. Debe funcionar a través de
//	 JOptionPane y funcionar con entradas en este formato (sin comillas) “convertir 3 kilos a libras”,
//	 “convertir 3 kilos a gramos”, “convertir 105 centímetros a metros”, etc. La respuesta debe ser
//	 presentada también a través de JOptionPane. En caso de entradas en formatos diferentes, la
//	 aplicación debe informar dicho error.
			...
			try {
				...
				if(st.countTokens()==3) {
					...
					if( (valor1.equals("kilos")) && (valor2.equals("libras")) ) {
						...
						//convertir centímetros a metros y de metros a centímetros.
